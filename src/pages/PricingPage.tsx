        ...
        >
          ...
          <div className="space-y-3">
            {[
              ...
              { q: 'O que são as gotas de Elixir dos Mundos?', a: 'São os créditos de IA. O plano Idriel já vem com 100 gotas renovadas por mês — suficiente para a maioria dos autores. Se quiser mais, recarregue avulso a partir de R$ 4,90 sem mexer na assinatura.' },
