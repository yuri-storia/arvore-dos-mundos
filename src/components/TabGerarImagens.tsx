...
export const TabGerarImagens: React.FC<Props> = ({ state, setGeneratedPrompt, addToGallery }) => {
  ...
  const handleCreatePrompt = async () => {
    if (!planLimits.canUseAI) { setError('Idriel precisa do plano mensal para canalizar a Elixir dos Mundos. Faça o upgrade!'); return; }
  ...
  return (
    <div className="animate-fadeUp mx-auto max-w-[1060px] px-4 py-6">
      ...
      <p className="font-merriweather italic text-text-dim text-sm mb-5">
        Idriel canaliza a Elixir dos Mundos da Árvore para materializar as visões do seu mundo · Descreva e ela dará forma
      </p>
