...
import { Sparkles, ScrollText, X, MessageCircle, Compass } from 'lucide-react';
...
const FAQ: Record<string, { label: string; items: { q: string; a: string }[] }> = {
  construir: {
    ...
    items: [
      ...
      { q: 'O que é o Elixir dos Mundos?', a: 'É a **poção que Idriel destila** a partir da **Seiva Lendária da Árvore dos Mundos** — a essência que alimenta toda a magia criativa da plataforma. Cada gota libera um poder: **texto e consulta a Idriel (1 gota)**, **análise de mundo (1 gota)**, **importar documento (1 gota)** e **geração de imagem em 3 níveis: Rascunho (2 gotas), Padrão (5 gotas) e Qualidade Máxima (15 gotas)**. O plano Idriel garante **100 gotas renovadas por mês**.' },
  ...
  codex: {
    ...
    items: [
      ...
      { q: 'O que é a Análise de Mundo?', a: 'A Análise de Mundo usa IA para avaliar todo o seu Codex e dar feedback sobre coerência, lacunas e sugestões de melhoria. Custa **1 gota de Elixir dos Mundos**. Disponível apenas no plano Idriel.' },
  ...
  galeria: {
    ...
    items: [
      ...
      { q: 'O que são as Visões de Idriel?', a: 'É a funcionalidade de **geração de imagens com IA em 3 níveis**: **Rascunho (2 gotas)** para esboços rápidos, **Padrão (5 gotas)** com canon do Codex e **Qualidade Máxima (15 gotas)** para capas e retratos cinematográficos. Disponível apenas no plano Idriel.' },
      { q: 'Quanto custa gerar uma imagem?', a: 'Depende do nível escolhido: **Rascunho (2 gotas)**, **Padrão (5 gotas)** ou **Qualidade Máxima (15 gotas)**. No plano Idriel você tem 100 gotas por mês.' },
    ],
  },
  geral: {
    label: 'Geral',
    items: [
      { q: 'Como posso ter acesso à geração de imagens e análise do mundo?', a: 'Essas funcionalidades estão disponíveis exclusivamente no **plano Idriel** (R$ 39,90/mês ou R$ 397/ano). Para fazer upgrade:\n\n1. Clique no seu avatar no canto superior direito\n2. Vá em **Configurações** ou clique no banner de upgrade\n3. Escolha o plano Idriel\n\nCom o plano Idriel você recebe **100 gotas de Elixir dos Mundos por mês** para usar em geração de imagens (Rascunho 2 gotas / Padrão 5 gotas / Qualidade Máxima 15 gotas), consultas de IA (1 gota) e análise de mundo (1 gota).' },
