  ...
  return (
    <>
      ...
      <button
        ...
        className="group fixed top-4 right-3 sm:top-5 sm:right-5 z-[140] flex items-center gap-3 pl-1.5 pr-2 sm:pr-4 py-1.5 rounded-full transition-all hover:-translate-y-0.5 active:scale-95"
        style={{
          background:
