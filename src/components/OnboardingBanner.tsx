            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="mt-2 text-[11px] text-text-dim font-merriweather italic">
                  <><Leaf className="inline-block w-3.5 h-3.5 mr-1.5 align-[-0.15em] text-gold-champagne" strokeWidth={1.75} />Acompanhe sua Elixir dos Mundos no banner dourado no topo da página. A cada lua nova (mês), Idriel renova sua energia!</>
                </p>
              </div>
            </div>
          </div>
