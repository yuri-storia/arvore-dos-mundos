        ...
        <div className="mt-2 rounded-lg p-5 sm:p-6 backdrop-blur-[20px] border border-gold-light/30 shadow-[0_4px_30px_rgba(200,146,42,0.15)] animate-fadeUp" style={{ background: 'linear-gradient(135deg, hsl(38 67% 48% / 0.25) 0%, hsl(38 73% 60% / 0.18) 50%, hsl(38 67% 48% / 0.22) 100%)' }}>
          ...
          <div className="mt-5 rounded-lg p-4 border border-amber-500/30 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(180,130,20,0.15) 0%, rgba(218,165,32,0.08) 100%)' }}>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                <h3 className="font-montserrat font-bold text-sm text-gold-light">
                  Elixir dos Mundos — Energia de Idriel
                </h3>
                <p className="font-merriweather text-text-secondary text-xs leading-relaxed mt-1">
                  Idriel destila o <strong className="text-gold-light">Elixir dos Mundos</strong> a partir da <strong className="text-gold-light">Seiva Lendária da Árvore dos Mundos</strong> — a essência viva que alimenta toda magia desta plataforma. Seu plano inclui <strong className="text-gold-light">150 gotas</strong> por mês. Texto, consulta a Idriel, análise de mundo e import de documentos custam <strong className="text-gold-light">1 gota</strong>; imagens custam <strong className="text-gold-light">5 gotas (Essencial)</strong> ou <strong className="text-gold-light">9 (Alta Fidelidade)</strong>; mapas, <strong className="text-gold-light">7</strong> ou <strong className="text-gold-light">10 gotas</strong>.
                </p>
