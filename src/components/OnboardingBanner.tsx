          ...
          <div className="mt-5 rounded-lg p-4 border border-amber-500/30 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(180,130,20,0.15) 0%, rgba(218,165,32,0.08) 100%)' }}>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="font-merriweather text-text-secondary text-xs leading-relaxed mt-1">
                  Idriel destila o <strong className="text-gold-light">Elixir dos Mundos</strong> a partir da <strong className="text-gold-light">Seiva Lendária da Árvore dos Mundos</strong> — a essência viva que alimenta toda magia desta plataforma. Seu plano inclui <strong className="text-gold-light">100 gotas</strong> por mês. Texto, consulta a Idriel, análise de mundo e import de documentos custam <strong className="text-gold-light">1 gota</strong>; imagens vão de <strong className="text-gold-light">2 gotas (Rascunho)</strong> a <strong className="text-gold-light">5 (Padrão)</strong> ou <strong className="text-gold-light">15 (Qualidade Máxima)</strong>.
                </p>
