...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    desc: 'Dentro de cada Fruto, viajante, você pode me consultar! Use os chips de sugestão ou escreva sua dúvida. Este recurso é exclusivo do plano Template + Idriel e custa apenas 1 gota de Elixir.',
    Icon: Leaf,
    tooltipPos: 'top',
    delay: 200,
  },
  ...
  },
  {
    ...
    desc: 'Aqui eu materializo as visões do seu mundo, viajante! Descreva o que imagina, escolha estilo e tom, e eu gero a imagem com IA. Cada visão custa 5 gotas de Elixir dos Mundos. Este recurso é exclusivo do plano completo.',
    Icon: Sparkles,
    tooltipPos: 'top',
    delay: 200,
  },
