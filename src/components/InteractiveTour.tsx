...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    type: 'highlight',
    target: 'fruit-grid',
    title: 'Preencha um Fruto e salve',
    desc: 'Cada card é um pilar do seu universo. Abra um, escreva o que já sabe (mesmo que seja uma frase) e salve: aquilo vira automaticamente uma ficha ou artigo no seu Codex. Comece pelo que te empolga.',
    Icon: Apple,
    tooltipPos: 'bottom',
    mobileCard: 'auto',
    delay: 400,
  ...
  },
  {
    ...
    title: 'Pedir ajuda a mim, dentro do Fruto',
    desc: 'Travou? Aqui você me consulta sobre aquele pilar específico — uso as sugestões rápidas ou sua própria pergunta. Cada consulta custa 1 gota de Elixir e está no plano Idriel. A caneta continua sendo sua: eu só ofereço faíscas.',
    Icon: Leaf,
    tooltipPos: 'top',
    mobileCard: 'auto',
    delay: 200,
