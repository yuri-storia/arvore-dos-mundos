...
export const TimelineNode: React.FC<Props> = ({
  ...
  return (
    <div
      className="
        relative grid items-center gap-x-3 lg:gap-x-6 min-h-[80px] lg:min-h-[100px]
        grid-cols-[4rem_1fr]
        lg:grid-cols-[1fr_4rem_1fr]
      "
    >
      ...
      <div className="relative flex justify-center">
        <motion.button
          ...
          className="relative z-10 w-9 h-9 lg:w-10 lg:h-10 rounded-full flex items-center justify-center border-2 border-gold text-[#1a0f00] bg-gradient-to-br from-gold-champagne via-gold to-gold-deep shadow-[0_0_18px_hsl(var(--gold)/0.55)] hover:shadow-[0_0_26px_hsl(var(--gold)/0.85)] transition-shadow"
      ...
      <div className={`min-w-0 ${isRight ? 'lg:pl-2' : 'lg:hidden'}`}>
        <NodeCard
